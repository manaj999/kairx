...
function postData(data){
	...
	for(var i = 0; i < data.length; i++){
		for(var j = 0; j < data[i].dates.length; j++){
	         ...
	         textnode2=document.createTextNode(data[i].dates[j].startdate.toString().substring(0,16));
	         textnode3=document.createTextNode(data[i].dates[j].enddate.toString().substring(0,16));
	         textnode4=document.createTextNode("Take 1 50mg pill per day");
	         textnode5=document.createTextNode("Dr. Bora Chang");
